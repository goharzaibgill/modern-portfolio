exports.handler = async (event) => {
  ...
  const getReply = (msg) => {
    if (msg.match(/project|built|work|portfolio|election|resume|cgpa|ngo|software house/)) {
      return `Here are Gohar's live projects! 🚀\n\n🗳️ Election Management System\nReal-time voting platform with JWT auth, WebSockets & anonymous voting\nTech: React, Node.js, PostgreSQL, WebSockets\n🔗 Live: https://goharelectionsystem.netlify.app\n\n🎓 UniFind Pakistan\nFree university discovery platform — 72+ universities, comparison tool, merit calculator\nTech: HTML5, CSS3, Vanilla JS\n🔗 Live: https://pakunifind.netlify.app\n\n🏢 Software House Website\nModern SaaS-style site for digital services & portfolio\nTech: HTML5, CSS3, JavaScript\n🔗 Live: https://goharzaibgill.github.io/gillsolutions\n\n❤️ Care Society (NGO Platform)\nVolunteer management & blood donation campaigns\nTech: HTML5, CSS3, JavaScript\n🔗 Live: https://goharzaibgill.github.io/care-society\n\n🎓 Smart CGPA Calculator\nAcademic tool with instant GPA results\nTech: HTML5, CSS3, JavaScript\n🔗 Live: https://goharzaibgill.github.io/CGPA-calolator\n\n📄 Resume Builder\nModern resume builder with export-ready templates\nTech: HTML5, CSS3, JavaScript\n🔗 Live: https://goharresumebuilder.netlify.app\n\n🎉 Grand Events\nEvent management website with responsive design\n🔗 Live: https://grand-events.netlify.app\n\nAsk me about any specific project for more details!`;
    }
